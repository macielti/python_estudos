...
for name in languages.keys():
    ...
    if name in friends:
        ...
        print(name.title()+", você sabe programar?\n")
...
# na linha 12 eu criei um else para ser executado quando o nome do amigo não estiver na lista.
#caso o else seja verdadeiro ele exiibe uma mensagem.